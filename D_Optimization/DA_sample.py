...
def random_search(target, result_num=5, attention=True, bias=torch.ones(7).to(torch.float32), decode_mode='async',
...
if __name__ == '__main__':
    ...
    random_search([5, 2, 5, 3.5, 4, 5, 1], bias=bias, burte_force_link=False)
